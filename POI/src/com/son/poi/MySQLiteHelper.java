...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_CREATE = "create table " + TABLE_POIS + "(" + COLUMN_ID
			+ " integer primary key autoincrement, " + COLUMN_BUSINESS + " string, " + COLUMN_ADDRESS
			+ " string not null, " + COLUMN_VISITS + " integer);";
